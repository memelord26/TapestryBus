    ...
    return(
        <>
            <div className="content">
                ...
                <br />
                <p>Note: This schedule is based on the one released on 15th July 2026</p>
                <br />
                <p className="content-notes">Tap the image to see the full version</p>
                <a href={`${import.meta.env.BASE_URL}schedule/bus_july2026.png`} target="_blank" rel="noopener noreferrer">
                    <img src={`${import.meta.env.BASE_URL}schedule/bus_july2026.png`} alt="Dec'25 Bus Schedule"  style={{width: '200px'}}/>
                </a>
            </div>
        </>
    );
